...
workflows. Originally based on McBain's
[`dflow`](https://github.com/MilesMcBain/dflow) for drake workflows and tailored
to our report-generating projects. But we will be including other approaches
here as well.
